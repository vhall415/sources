...
set_property PACKAGE_PIN K2 [get_ports {vsync}]
set_property PACKAGE_PIN G2 [get_ports {href}]
...
set_property PACKAGE_PIN G4 [get_ports {cam_byte[0]}]
set_property PACKAGE_PIN E5 [get_ports {cam_byte[1]}]
set_property PACKAGE_PIN G3 [get_ports {cam_byte[2]}]
set_property PACKAGE_PIN C4 [get_ports {cam_byte[3]}]
set_property PACKAGE_PIN F5 [get_ports {cam_byte[4]}]
set_property PACKAGE_PIN B4 [get_ports {cam_byte[5]}]
set_property PACKAGE_PIN F3 [get_ports {cam_byte[6]}]
set_property PACKAGE_PIN J3 [get_ports {cam_byte[7]}]
